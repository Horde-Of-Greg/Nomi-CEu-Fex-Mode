...
mods.draconicevolution.fusion.recipeBuilder()
    ...
    .input(
        item('solarflux:solar_panel_draconic'),
...
mods.draconicevolution.fusion.recipeBuilder()
    ...
    .input(
        item('solarflux:solar_panel_8'),
        item('solarflux:solar_panel_8'),
        item('enderio:item_endergy_conduit', 10),
        item('enderio:item_endergy_conduit', 10),
        metaitem('nomilabs:blockDraconium'),
        metaitem('nomilabs:blockDraconium'),
        item('enderio:item_endergy_conduit', 10),
        item('enderio:item_endergy_conduit', 10),
        item('solarflux:solar_panel_8'),
...
mods.draconicevolution.fusion.recipeBuilder()
    ...
    .input(
        metaitem('nomilabs:blockAwakenedDraconium'),
        metaitem('nomilabs:blockAwakenedDraconium'),
        item('draconicevolution:chaos_shard'),
        item('draconicevolution:chaos_shard'),
        item('nomilabs:stabilizedeinsteinium'),
        item('nomilabs:stabilizedeinsteinium'),
        item('draconicevolution:chaos_shard'),
        item('draconicevolution:chaos_shard'),
        metaitem('nomilabs:blockAwakenedDraconium'),
...
mods.draconicevolution.fusion.recipeBuilder()
    ...
    .input(
        item('draconicevolution:chaos_shard'),
        item('draconicevolution:chaos_shard'),
        metaitem('ingotNeutronium'),
        metaitem('ingotNeutronium'),
        metaitem('nomilabs:blockCrystalMatrix'),
        metaitem('nomilabs:blockCrystalMatrix'),
        metaitem('ingotNeutronium'),
        metaitem('ingotNeutronium'),
        item('draconicevolution:chaos_shard'),
...
mods.draconicevolution.fusion.recipeBuilder()
    ...
    .input(
        item('extrautils2:compressedcobblestone', 3),
        metaitem('nomilabs:blockDarkSteel'),
        metaitem('nomilabs:dustDraconium'),
        metaitem('nomilabs:dustDraconium'),
        item('thermalfoundation:material', 1024),
        item('thermalfoundation:material', 1024),
        item('armorplus:compressed_obsidian'),
        item('armorplus:compressed_obsidian'),
        item('armorplus:lava_crystal', 1),
        item('armorplus:lava_crystal', 1))
...
mods.draconicevolution.fusion.recipeBuilder()
    .catalyst(item('draconicevolution:wyvern_energy_core'))
    .input(
        metaitem('nomilabs:ingotAwakenedDraconium'),
        metaitem('nomilabs:ingotAwakenedDraconium'),
        item('draconicevolution:awakened_core'),
        item('draconicevolution:awakened_core'),
...
mods.draconicevolution.fusion.recipeBuilder()
    ...
    .input(
        ...
        metaitem('ingotNeutronium'),
        metaitem('ingotNeutronium'),
        item('extendedcrafting:material', 32),
        item('extendedcrafting:material', 32),
        metaitem('ingotNeutronium'),
        metaitem('ingotNeutronium'),
        item('draconicevolution:chaos_shard'),
...
mods.draconicevolution.fusion.recipeBuilder()
    ...
    .input(
        ...
        metaitem('nomilabs:ingotDraconium'),
        item('minecraft:ender_pearl'),
        metaitem('nomilabs:ingotDraconium'),
        item('minecraft:ender_pearl'),
        metaitem('nomilabs:ingotDraconium'),
...
mods.gregtech.assembler.recipeBuilder()
    .inputs(
        ...
        item('extendedcrafting:interface') * 4,
        item('packagedauto:me_package_component') * 4,
        item('extendedcrafting:material', 12) * 4,
...
mods.gregtech.assembler.recipeBuilder()
    .inputs(
        ...
        item('extendedcrafting:material', 19),
        metaitem('sensor.iv'),
        ore('gearDraconium'))
...
mods.gregtech.assembler.recipeBuilder()
    .inputs(
        item('draconicevolution:crafting_injector', 3),
        item('extendedcrafting:material', 19),
        metaitem('sensor.iv'),
        ore('gearDraconium'))
